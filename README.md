...
*   **Long Prompt Bubble Wrapping**: User chat bubbles now wrap long identifiers, filenames, and hyphenated English prompts instead of clipping them inside the blue bubble.
