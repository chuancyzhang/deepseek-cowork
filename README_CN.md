...
- **右侧上下文抽屉**：需要时从窗口右侧展开贴边任务面板，用浏览态查找文件和交付物，点击后下钻到专注预览与操作态；对话里的交付物卡片、工作区完整路径和 Markdown 文件链接会直接打开预览。
...
- **设置中心**：管理模型、智能体、默认工作区、归档项目与对话、MCP、企业消息和组件依赖。
- **首页工具包提示**：新会话首页会提示可在设置中安装文档工具包和数据分析工具包，便于处理 Office/PDF、表格、数据分析和可视化任务。
- **自动化中心**：管理提示词任务、定时计划、执行历史、引用能力和可选 Agent 绑定。
