...
- **PPT Mode / PPT Agent**：侧栏和首页提供 PPT Agent 入口，支持自动选择、网页演示、技术分享、高审美商业汇报和模板化办公 PPT 等偏好；内置 Guizang PPT Skill、Frontend Slides、Huashu Design 三类 html-ppt 策略，输出统一注册为 HTML 交付物，再复用现有 PPTX/DOCX/PDF 转换链路。
...
6. 需要完整 PPT 工作流时，打开 **PPT Agent**，填写需求，选择自动或偏好策略，可附加资料和 PPTX 模板。
