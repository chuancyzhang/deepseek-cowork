...
交付物预览按格式分发：HTML/Markdown 使用 WebEngine，PDF 优先使用 QtPdf 且在组件不可用时提供 pypdf 文本预览，DOCX/PPTX/XLSX 使用应用内结构化 HTML 预览，不依赖用户本机 Microsoft Office。
