...
class LLMWorker(QThread):
    ...
    def _build_stable_system_prompt(self):
        ...
        stable_policy_lines = [
            ...
            "能力分层: 核心内置能力只包含始终启用的基础能力；浏览器自动化、网页搜索、金融数据、Office/PDF 读取等随包能力位于 ai_skills，是默认关闭的可选插件，并可在设置中提前安装对应工具包。",
            ...
            "4. 技能创建/维护: 使用 'create_new_skill'、'update_skill'、'install_agent_skill'、'analyze_skill_source_folder'、'generate_skill_from_folder'、'run_skill_script'。",
