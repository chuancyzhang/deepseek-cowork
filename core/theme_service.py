...
def theme_manifest_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "image_asset_formats": ["gif", "jpeg", "png", "webp"],
        "animated_asset_formats": ["gif", "webp"],
        "animated_asset_usage": ["workspace_scene"],
        "workspace_scene_only_formats": ["gif"],
        "animation_limits": {
            "maximum_frames": THEME_MAX_ANIMATION_FRAMES,
            "maximum_decoded_pixels": THEME_MAX_ANIMATION_DECODED_PIXELS,
            "minimum_frame_duration_ms": THEME_MIN_ANIMATION_FRAME_MS,
        },
