...
聊天区、输入区和新对话首页。工作区背景可以是纯色、静态图片，或受控的条纹、
网格、点阵和噪点。
...
3. 需要图片时导入本地 PNG、JPEG 或 WebP；不接受 SVG、动画、网络地址或可执行内容。
4. 点击“预览”，一次性检查整套草稿。
...
- 注入任意 QSS、脚本、动画、SVG、网络资源或可执行内容；
- 修改 PDF、Office、HTML、图片等交付物内容。

首页卡片可以改变展示文案、图标、样式、位置或可见性，但预填提示词、PPT Mode、
