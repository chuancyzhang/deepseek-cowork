...
外观与能力入口复用[用户指南](../user-guide.md)截图；其余主题预览和交互结果图仅展示对应场景，不代表整套当前导航。
...
![设置中的外观页面](user-guide/23-settings-01.png)
...
![能力入口](user-guide/17-skillhub-01.png)

![选择 Visualize 能力](../../images/ai-theme-visualize/08-3ed814f2.png)

*在 AI 能力商城中找到并开启 Visualize*

### 2.2 开始使用

1. 从“能力 → 技能”找到并开启 Visualize，再在对话中按需指定该能力。
...
筛选器和参数控件取决于当前生成的视图；可明确要求 AI 提供需要的交互。
